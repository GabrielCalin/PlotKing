REWRITE_PRESETS = {
    ...
    "Style Match": "Rewrite the text in the style of {style}, keeping the original meaning, events, and structure intact.",
    "Deepen Theme": "Rewrite the text so that it subtly reinforces the theme of {theme}, without adding new plot events or altering character motivations.",
    "Dialogue Boost": "Rewrite the text by converting suitable narrative moments into natural dialogue and increasing character interaction, while preserving plot and meaning.",
    "Heighten Tension": "Rewrite the text to increase tension, urgency, and stakes, without introducing new events or changing the plot."
}
